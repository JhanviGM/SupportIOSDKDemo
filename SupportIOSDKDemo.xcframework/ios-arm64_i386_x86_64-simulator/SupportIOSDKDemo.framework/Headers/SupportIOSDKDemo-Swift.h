...
#ifndef SUPPORTIOSDKDEMO_SWIFT_H
#define SUPPORTIOSDKDEMO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SupportIOSDKDemo",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class AcquireIOConfig;

SWIFT_CLASS("_TtC16SupportIOSDKDemo9AcquireIO")
...
@interface AcquireIO (SWIFT_EXTENSION(SupportIOSDKDemo))
...
SWIFT_CLASS("_TtC16SupportIOSDKDemo15AcquireIOConfig")
...
@interface UIViewController (SWIFT_EXTENSION(SupportIOSDKDemo))
- (void)awakeFromNib;
@end
